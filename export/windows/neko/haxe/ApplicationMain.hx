...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("Batoust", "StarbrewValley", "com.example.myapp", "0.0.1");
		...
		telemetryConfig.app_name = "StarbrewValley";
		#end
		...
		flash.Lib.create (function () {
				...
				for (methodName in Type.getClassFields (batoust.games.Main)) {
				...
				if (hasMain) {
					...
					Reflect.callMethod (batoust.games.Main, Reflect.field (batoust.games.Main, "main"), []);
...
@:keep class DocumentClass extends batoust.games.Main {}
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "StarbrewValley", null, { width: 640, height: 480 });
			...
			if (hasMain) {
				...
				var instance = Type.createInstance (batoust.games.Main, []);
			}
...
class ApplicationMain {
	...
	public static function start ():Void {
		...
		var hasMain = false;
		var entryPoint = Type.resolveClass ("batoust.games.Main");
